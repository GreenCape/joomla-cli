 ...
 *
 * @return bool|mixed Returns everything as strings except for abstract types (ROWIDs, LOBs and FILEs). Returns FALSE
 *                    on error.
 */
 ...
 * @param  resource  $statement_resource
 *
 * @return string Returns everything as strings except for abstract types (ROWIDs, LOBs and FILEs). Returns FALSE on
 *                error.
 */
 ...
 *
 * @return mixed <p>Returns <b>FALSE</b> if such element doesn't exist; <b>NULL</b> if element is <b>NULL</b>; string
 *               if element is column of a string datatype or number if element is numeric field.
 */
