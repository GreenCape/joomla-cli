...
class Judy implements ArrayAccess
{
     ...
     *
     * @param  int  $nth_index  <p>Nth index to return. If nth_index equal 1, then it will return the first index in
     *                          the array.</p>
     *
     ...
     *
     * @param  mixed  $index  [optional] <p>The index can be an integer or a string corresponding to the index where to
     *                        start the search.</p>
     *
     ...
     *
     * @param  mixed  $index  <p>The index can be an integer or a string corresponding to the index where to start the
     *                        search.</p>
     *
     * @return mixed <p>Return the corresponding index in the array.</p>
     */
