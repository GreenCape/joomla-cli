 ...
 *                             ...).
 * @param  int &   $ndocs      [optional] If ndocs is provided, then it is filled with the number of documents found in
 *                 stream.
 * @param  array   $callbacks  [optional] Content handlers for YAML nodes. Associative array of YAML tag => callable
 *                             mappings. See parse callbacks for more details.
 *
 * @return mixed Returns the value encoded in input in appropriate PHP type or FALSE on failure. If pos is -1 an array
