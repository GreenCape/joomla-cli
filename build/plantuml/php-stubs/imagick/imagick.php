...
class Imagick implements Iterator, Countable
{
     ...
     *                              </p>
     * @param  bool    $only_names  [optional] <p>
     *                              Whether to return only profile names. If <b>FALSE</b> then values are returned as
     *                              well
     *                              </p>
     *
     ...
     *                           The value can be any combination or order of R = red, G = green, B = blue, A = alpha
     *                           (0 is transparent), O = opacity (0 is opaque), C = cyan, Y = yellow, M = magenta, K =
...
class ImagickDraw
{
     ...
     *                              multidimensional array like array( array( 'x' => 3, 'y' => 4 ), array( 'x' => 2,
     *                              'y' => 6 ) );
     *                              </p>
     *
     * @return bool <b>TRUE</b> on success.
     ...
     *
     * @param  array  $coordinates  <p>
     *                              array of x and y coordinates: array( array( 'x' => 4, 'y' => 6 ), array( 'x' => 8,
     *                              'y' => 10 ) )
     *                              </p>
     *
     * @return bool <b>TRUE</b> on success.
