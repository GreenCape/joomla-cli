 ...
 *                             passed, the stored variable will be expunged from the cache (on the next request). If no
 *                             ttl is supplied
 ...
 *                                  The constant_name must follow the normal constant naming rules. Value must evaluate
 *                                  to a scalar value.
 ...
 *                                    array() will dump nothing.
 *
 * @return string|bool|null Returns a binary dump of the given files and user variables from the APC cache, FALSE if
