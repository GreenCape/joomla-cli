...
class SQLiteDatabase
{
     ...
     *
     * @param $filename       <p>The filename of the SQLite database. If the file does not exist, SQLite will attempt
     *                        to create it. PHP must have write permissions to the file if data is inserted, the
     *                        database schema is modified or to create the database if it does not exist.</p>
     ...
     *                        {@link http://php.net/manual/en/function.sqlite-escape-string.php properly escaped}.
     *                        </p>
     ...
     *                        indices (named fields) while <b>SQLITE_NUM</b> will return only numerical indices
     *                        (ordinal field numbers). <b>SQLITE_BOTH</b> will return both associative and numerical
     *                        indices. <b>SQLITE_BOTH</b> is the default for this function.</p>
     ...
     *                       will return immediately with a <b>SQLITE_BUSY</b> status code if another process/thread
     *                       has the database locked for an update. PHP sets the default busy timeout to be 60 seconds
     *                       when the database is opened.</p>
     *
...
final class SQLiteResult implements Iterator, Countable
{
     ...
     *                        parameter is set to <b>TRUE</b> (the default), PHP will decode the binary encoding
     *                        it applied to the data if it was encoded using the
     *                        {@link http://php.net/manual/en/sqlite.configuration.php#ini.sqlite.assoc-case sqlite.assoc_case}. You should normally leave this value at its default, unless you are interoperating with databases created by other sqlite capable applications.</p>
     *
     * @return array <p>
 ...
 * @param  resource  $result         <p>The SQLite result resource. This parameter is not required when using the
 *                                   object-oriented method.</p>
 * @param  int       $result_type    [optional] <p>The optional result_type parameter accepts a constant and determines
 *                                   how the returned array will be indexed. Using <b>SQLITE_ASSOC</b> will return only
 *                                   associative indices (named fields) while <b>SQLITE_NUM</b> will return only
 *                                   numerical indices (ordinal field numbers). <b>SQLITE_BOTH</b> will return both
 *                                   associative and numerical indices. <b>SQLITE_BOTH</b> is the default for this
 *                                   function.</p>
