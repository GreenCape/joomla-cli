...
namespace MongoDB\Driver {
    ...
    final class Manager
    {
         ...
         * @param  WriteConcern  $writeConcern  Optionally, a MongoDB\Driver\WriteConcern. If none given, default to
         *                                      the Write Concern set by the MongoDB Connection URI.
         *
         * @return WriteResult
         */
         ...
         * @param  ReadPreference  $readPreference  Optionally, a MongoDB\Driver\ReadPreference to route the command
         *                                          to. If none given, defaults to the Read Preferences set by the
    ...
    final class Server
    {
         ...
         * @param  ReadPreference  $readPreference  Optionally, a MongoDB\Driver\ReadPreference to select the server
         *                                          for this operation. If none is given, the read preference from the
         ...
         * @throws InvalidArgumentException on argument parsing errors.
         * @return array An array of tags used to describe this server in a replica set. The array will contain zero or
         *               more string key and value pairs.
         */
...
namespace MongoDB\BSON {
    ...
    class ObjectID implements Type
    {
         ...
         *
         * @param  string  $id  A 24-character hexadecimal string. If not provided, the driver will generate an
         *                      ObjectID.
         *
