...
/**
 * The maximum value to which the process can be <a href="http://php.net/manual/en/function.pcntl-setpriority.php">
 * reniced</a> to. The value that will be used will be 20 - limit, as resource limit values cannot be negative.
 *
 * @link http://php.net/manual/en/posix.constants.setrlimit.php
 */
