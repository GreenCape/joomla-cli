...
class Memcached
{
     ...
     *                                of hashing on the actual key for the item, we hash on the server key when
     *                                deciding which memcached server to talk to. This allows related items to be
     *                                grouped together on a single server for efficiency with multi operations.
     *                                </p>
     * @param  string    $key         <p>
     ...
     *                                 Instead of hashing on the actual key for the item, we hash on the server key
     *                                 when deciding which memcached server to talk to. This allows related items to be
     *                                 grouped together on a single server for efficiency with multi operations.
     *                                 </p>
     * @param  string  $key            <p>
     *                                 The key of the item to increment.
