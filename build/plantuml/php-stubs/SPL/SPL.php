...
class CallbackFilterIterator extends FilterIterator
{
     ...
     * @param  callable  $callback  The callback, which should return TRUE to accept the current item or FALSE
     *                              otherwise. May be any valid callable value. The callback should accept up to three
     *                              arguments: the current item, the current key and the iterator, respectively.
...
class LimitIterator extends IteratorIterator
{
     ...
     * @param  int       $count     [optional] The number of items to iterate. Must be -1 or greater. -1, the default,
     *                              means no limit.
     *
     * @since 5.1.0
     */
...
class CachingIterator extends IteratorIterator implements ArrayAccess, Countable
{
    ...
    /**
     * Cache all read data. This is needed to use {@see CachingIterator::getCache}, and ArrayAccess and Countable
     * methods.
     */
...
class RecursiveTreeIterator extends RecursiveIteratorIterator
{
     ...
     * @param  int                                  $flags             [optional] Flags to control the behavior of the
     *                                                                 RecursiveTreeIterator object.
     * @param  int                                  $caching_it_flags  [optional] Flags to affect the behavior of the
     *                                                                 {@see RecursiveCachingIterator} used internally.
     * @param  int                                  $mode              [optional] Flags to affect the behavior of the
     *                                                                 {@see RecursiveIteratorIterator} used
     *                                                                 internally.
     *
     * @since 5.3.0
     */
...
class ArrayObject implements IteratorAggregate, ArrayAccess, Serializable, Countable
{
     ...
     * @param  string        $iterator_class  Specify the class that will be used for iteration of the ArrayObject
