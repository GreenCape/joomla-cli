 ...
 *                                to the function, they are automatically executed as one transaction, unless there are
 *                                explicit BEGIN/COMMIT commands included in the query string. However, using multiple
