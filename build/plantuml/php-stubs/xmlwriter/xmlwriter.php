 ...
 *                            The XMLWriter {@link http://php.net/manual/en/language.types.resource.php" resource} that
 *                            is being modified. This resource comes from a call to
 *                            {@link http://php.net/manual/en/function.xmlwriter-open-uri.php" xmlwriter_open_uri()} or
 *                            {@link http://php.net/manual/en/function.xmlwriter-open-memory.php" xmlwriter_open_memory()}.</p>
 * @param  bool      $indent  <p>
 *                            Whether indentation is enabled.
 *                            </p>
 *
 ...
 * @param  resource  $xmlwriter
 *                                  <p>Only for procedural calls.
 *                                  The XMLWriter {@link http://php.net/manual/en/language.types.resource.php"
 *                                  resource} that is being modified. This resource comes from a call to
 *                                  {@link http://php.net/manual/en/function.xmlwriter-open-uri.php" xmlwriter_open_uri()} or {@link http://php.net/manual/en/function.xmlwriter-open-memory.php" xmlwriter_open_memory()}.</p>
 * @param  string    $indentString  <p>
 *                                  The indentation string.
 *                                  </p>
 *
 ...
 * {@link http://php.net/manual/en/function.xmlwriter-open-uri.php" xmlwriter_open_uri()} or
 * {@link http://php.net/manual/en/function.xmlwriter-open-memory.php" xmlwriter_open_memory()}.</p> * @return bool
 ...
 * @param  resource  $xmlwriter
 *                             <p>Only for procedural calls.
 *                             The XMLWriter {@link http://php.net/manual/en/language.types.resource.php" resource}
 *                             that is being modified. This resource comes from a call to
 *                             {@link http://php.net/manual/en/function.xmlwriter-open-uri.php" xmlwriter_open_uri()}
 *                             or
 *                             {@link http://php.net/manual/en/function.xmlwriter-open-memory.php" xmlwriter_open_memory()}.</p>
 * @param  string    $prefix   <p>
 *                             The namespace prefix.
