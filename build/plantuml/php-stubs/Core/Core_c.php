...
final class Closure
{
     ...
     * @param  mixed   $newscope  The class scope to which associate the closure is to be associated, or 'static' to
     *                            keep the current one. If an object is given, the type of the object will be used
     *                            instead. This determines the visibility of protected and private methods of the bound
     *                            object.
     *
     ...
     * @param  mixed   $parameters  [optional] Zero or more parameters, which will be given as parameters to the
     *                              closure.
     *
     * @return mixed
     * @since 7.0
