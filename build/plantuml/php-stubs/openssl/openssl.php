 ...
 *                               {@link http://php.net/en/manual/function.openssl-pkey-new.php openssl_pkey_new()} (or
 *                               otherwise obtained from the other openssl_pkey family of functions). The corresponding
 ...
 *                              </p>
 * @param  string  $key         <p>
 *                              The key. For a list of available cipher methods, use {@see
 ...
 *                              </p>
 * @param  string &$tag         <p>The authentication tag passed by reference when using AEAD cipher mode (GCM or
 *                              CCM).</p>
 ...
 *                            The authentication tag in AEAD cipher mode. If it is incorrect, the authentication fails
 *                            and the function returns <b>FALSE</b>.
 *                            </p>
