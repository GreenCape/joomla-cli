...
class HttpMessage implements Countable, Serializable, Iterator
{
     ...
     *
     * @param  array  $headers  <p>
     *                          associative array containing the additional HTTP headers to add to the messages
     *                          existing headers
     *                          </p>
...
class HttpRequest
{
     ...
     *                              whether only session cookies should be reset (needs libcurl >= v7.15.4, else
     *                              libcurl >= v7.14.1)
     *                              </p>
     *
     * @return bool true on success or false on failure.
...
class HttpResponse
{
     ...
     *                                   whether the cached entity should be revalidated by the client for every
     *                                   request
     *                                   </p>
     *
