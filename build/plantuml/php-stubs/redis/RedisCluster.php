...
class RedisCluster
{
     ...
     * $redisCluster->zUnionStore('ko2', array('k1', 'k2'), array(1, 1)); // 4, 'ko2' => array('val0', 'val1',
     * 'val2','val3')
     * $redisCluster->zUnionStore('ko3', array('k1', 'k2'), array(5, 1)); // 4, 'ko3' => array('val0', 'val2',
     * 'val3','val1')
     * </pre>
     */
     ...
     * @example
     * <pre>
     * $redisCluster->setOption(RedisCluster::OPT_SERIALIZER, RedisCluster::SERIALIZER_NONE);        // don't serialize
     * data
     * $redisCluster->setOption(RedisCluster::OPT_SERIALIZER, RedisCluster::SERIALIZER_PHP);         // use built-in
     * serialize/unserialize
     * $redisCluster->setOption(RedisCluster::OPT_SERIALIZER, RedisCluster::SERIALIZER_IGBINARY);    // use igBinary
     * serialize/unserialize
     * $redisCluster->setOption(RedisCluster::OPT_PREFIX, 'myAppName:');                             // use custom
     * prefix on all keys
     * </pre>
     */
     ...
     * @param  string          $key         for `SET`, glob-pattern for `GET`. See http://redis.io/commands/config-get
     *                                      for examples.
     ...
     * @param  float   $latitude
     * @param  float   $radius
     * @param  string  $radiusUnit  String can be: "m" for meters; "km" for kilometers , "mi" for miles, or "ft" for
     *                              feet.
     * @param  array   $options
     *
