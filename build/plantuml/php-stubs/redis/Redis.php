...
class Redis
{
     ...
     * $redis->pconnect('127.0.0.1', 6379, 2.5);      // 2.5 sec timeout and would be another connection than the two
     * before.
     * $redis->pconnect('127.0.0.1', 6379, 2.5, 'x'); // x is sent as persistent_id and would be another connection
     * than the three before.
     * $redis->pconnect('/tmp/redis.sock');           // unix domain socket - would be another connection than the four
     * before.
     * </pre>
     */
     ...
     *                          SERVER | CLIENTS | MEMORY | PERSISTENCE | STATS | REPLICATION | CPU | CLASTER |
     *                          KEYSPACE | COMANDSTATS
     *
