 ...
 *                             The SNMP object id.
 *                             </p>
 * @param  string  $type       The MIB defines the type of each object id. It has to be specified as a single character
 *                             from the below list.
 *                             </p>
 *                             types
 ...
 *                             "SYNTAX BITS {telnet(0), ftp(1), http(2), icmp(3), snmp(4), ssh(5), https(6)}":
 *                             </p>
 *                             Using type "b" and a list of bit numbers. This method is not recommended since GET query
 *                             for the same OID would return e.g. 0xF8. Using type "x" and a hex number but without(!)
 *                             the usual "0x" prefix. See examples section for more details.
 *                             </p>
 * @param  mixed   $value      <p>
 *                             The new value.
 *                             </p>
 ...
 * </p>
 * <p>
 * If the SNMP host rejects the data type, an E_WARNING message like "Warning: Error in packet. Reason: (badValue) The
 * value given has the wrong type or length." is shown. If an unknown or invalid OID is specified the warning probably
 * reads "Could not add variable".
 * @since 4.0
 * @since 5.0
 */
 ...
 *                                   </table>
 *                                   Most of these will use the obvious corresponding ASN.1 type. &#x00027;s&#x00027;,
 *                                   &#x00027;x&#x00027;, &#x00027;d&#x00027; and &#x00027;b&#x00027; are all different
 *                                   ways of specifying an OCTET STRING value, and the &#x00027;u&#x00027; unsigned
 *                                   type is also used for handling Gauge32 values.
 *                                   </p>
