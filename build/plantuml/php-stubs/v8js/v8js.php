...
class V8Js
{
     ...
     * A time limit (milliseconds) and/or memory limit (bytes) can be provided to restrict execution. These options
     * will throw a V8JsTimeLimitException or V8JsMemoryLimitException.
     *
     * @param  string  $script
     ...
     * For best performance V8 is initialized only once per process thus this call has to be done before any V8Js
     * objects are created!
     *
