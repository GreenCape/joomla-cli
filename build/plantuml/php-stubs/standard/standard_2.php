 ...
 * @param  mixed   $needle    If needle is not a string, it is converted to an integer and applied as the ordinal value
 *                            of a character.
 * @param  bool    $part      [optional] If TRUE, strstr() returns the part of the haystack before the first occurrence
