 ...
 *                           GLOB_NOSORT - Return files as they appear in the directory (no sorting). When this flag is
 *                           not used, the pathnames are sorted alphabetically GLOB_NOCHECK - Return the search pattern
 *                           if no files matching it were found GLOB_NOESCAPE - Backslashes do not quote metacharacters
 *                           GLOB_BRACE - Expands {a,b,c} to match 'a', 'b', or 'c' GLOB_ONLYDIR - Return only
 *                           directory entries which match the pattern GLOB_ERR - Stop on read errors (like unreadable
