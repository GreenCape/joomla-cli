...
class php_user_filter
{
     ...
     * @param  resource  $out       <p>is a resource pointing to a second bucket brigade into which your modified
     *                              buckets should be placed.</p>
     * @param  int       $consumed  <p>which must <i>always</i> be declared by reference, should be incremented by the
     *                              length of the data which your filter reads in and alters. In most cases this means
     *                              you will increment consumed by <i>$bucket->datalen</i> for each <i>$bucket</i>.</p>
...
class Directory
{
    ...
    /**
     * @var resource Can be used with other directory functions such as {@see readdir()}, {@see rewinddir()} and
     *      {@see closedir()}.
     */
    public $handle;
 ...
 *                            such as
 *                            {@link http://www.php.net/manual/en/function.imagecreatetruecolor.php imagecreatetruecolor()}.</p>
 ...
 *                           {@link http://www.php.net/manual/en/function.imagecreatetruecolor.php imagecreatetruecolor()}.
 *                           </p>
 ...
 *
 * @param  resource  $image  <p>
 *                           An image resource, returnd by one of the image creation functions, such as
 *                           {@link http://www.php.net/manual/en/function.imagecreatetruecolor.php imagecreatetruecolor()}.
 *                           </p>
 *
