...
namespace {
     ...
     *                    index may be of type string or integer. When index is omitted, an integer index is
     *                    automatically generated, starting at 0. If index is an integer, next generated index will be
     *                    the biggest integer index + 1. Note that when two identical index are defined, the last
     *                    overwrite the first.
     *                    </p>
     *                    <p>
     ...
     *                      <p>Note: Prior to PHP 5.5, <b>empty()</b> only supports variables; anything else will
     *                      result in a parse error. In other words, the following will not work:
     *                      <b>empty(trim($name))</b>. Instead, use <b>trim($name) == false</b>.
     *                      </p>
     *                      <p>
     ...
     *                        </p>
     *                        <p>
     *                        Apart from that the passed code must be valid PHP. This includes that all statements must
     *                        be properly terminated using a semicolon.
     ...
     *                        </p>
     *                        <p>
     *                        The code will be executed in the scope of the code calling <b>eval()</b>. Thus any
     *                        variables defined or changed in the <b>eval()</b> call will remain visible after it
     *                        terminates.
     *                        </p>
     *
