 ...
 *                            Options for rrd create - list of strings. See man page of rrd create for whole list of
 *                            options.
 *                            </p>
 *
...
/**
 * Gets data for graph output from RRD database file as array. This function has same result as rrd_graph(), but
 ...
 *
 * @param  string  $filename  <p>
 *                            The filename to output the graph to. This will generally end in either .png, .svg or
 *                            .eps, depending on the format you want to output.
 *                            </p>
 * @param  array   $options   <p>
 *                            Options for generating image. See man page of rrd graph for all possible options. All
 *                            options (data definitions, variable defintions, etc.) are allowed.
 *                            </p>
 *
 * @return array If image is created successfully an array with information about generated image is returned, FALSE
 *               when error occurs.
 * @since PECL rrd >= 0.9.0
 */
...
/**
 * Gets array of the UNIX timestamp and the values stored for each date in the most recent update of the RRD database
 * file.
 *
 ...
 *                            </p>
 * @param  array   $options   <p>
 *                            Options with RRD database file properties which will be changed. See rrd tune man page
 *                            for details.
 *                            </p>
 *
 * @return bool Returns TRUE on success, FALSE otherwise.
...
/**
 * Updates the RRD database file. The input data is time interpolated according to the properties of the RRD database
 * file.
 *
 ...
 *                            </p>
 * @param  array   $options   <p>
 *                            Options for updating the RRD database. This is list of strings. See man page of rrd
 *                            update for whole list of options.
 *                            </p>
 *
 * @return bool Updates the RRD database file. The input data is time interpolated according to the properties of the
 *              RRD database file.
 * @since PECL rrd >= 0.9.0
 */
...
/**
 * Exports the information about RRD database file. This data can be converted to XML file via user space PHP script
 * and then restored back as RRD database file.
 *
 ...
 * This function is automatically called when the whole PHP process is terminated. It depends on used SAPI. For
 * example, it's called automatically at the end of command line script.</p><p> It's up user whether he wants to call
 * this function at the end of every request or otherwise.</p>
 *
...
class RRDCreator
{
     ...
     *                             Time for the first value in RRD database. Parameter supports all formats which are
     *                             supported by rrd create call.
     *                             </p>
     * @param  int     $step       <p>
     ...
     * Archive consists of a number of data values or statistics for each of the defined data-sources (DS). Data
     * sources are defined by method RRDCreator::addDataSource(). You need call this method for each requested archive.
     * </p>
     *
     ...
     * RRD can accept input from several data sources (DS), e.g incomming and outgoing traffic. This method adds data
     * source by description. You need call this method for each data source.
     * </p>
     *
     * @link  http://php.net/manual/en/rrdcreator.adddatasource.php
     *
     * @param  string  $description  <p>
     *                               Definition of data source - DS. This has same format as DS definition in rrd
     *                               create command. See man page of rrd create for more details.
     *                               </p>
     *
     * @return void
     * @since PECL rrd >= 0.9.0
...
class RRDGraph
{
    ...
    /**
     * Creates new RRDGraph instance. This instance is responsible for rendering the result of RRD database query into
     * image.
     *
     ...
     * @return array Array with detailed information about generated image is returned, optionally with image data,
     ...
     *
     * @param  array  $options  <p>
     *                          List of options for the image generation from the RRD database file. It can be list of
     *                          strings or list of strings with keys for better readability. Read the rrd graph man
     *                          pages for list of available options.
     *                          </p>
     *
     * @return void
     * @since PECL rrd >= 0.9.0
