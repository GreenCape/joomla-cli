...
class IntlDateFormatter
{
     ...
     *                       the ini setting
     *                       {@link "http://php.net/manual/en/datetime.configuration.php#ini.date.timezone" date.timezone} or through the function  {@link "http://php.net/manual/en/function.date-default-timezone-set.php" date_default_timezone_set()} and as returned by {@link "http://php.net/manual/en/function.date-default-timezone-get.php" date_default_timezone_get()}.
     *                       </p>
     *                       </li>
     *                       <li>
     *                       <p>
     *                       An {@link "http://php.net/manual/en/class.intltimezone.php" IntlTimeZone}, which will be
     *                       used directly.
     *                       </p>
     *                       </li>
     *                       <li>
     *                       <p>
     *                       A {@link "http://php.net/manual/en/class.datetimezone.php" DateTimeZone}. Its identifier
     *                       will be extracted and an ICU timezone object will be created; the timezone will be backed
     ...
     *                          An object of type
     *                          {@link "http://www.php.net/manual/en/class.intlcalendar.php" IntlCalendar} or
     *                          {@link "http://www.php.net/manual/en/class.datetime.php" DateTime}. The timezone
     *                          information in the object will be used.
     *                          </p>
     * @param  mixed   $format  [optional] <p>
     *                          How to format the date/time. This can either be an
     *                          {@link "http://www.php.net/manual/en/language.types.array.php" array} with two elements
     *                          (first the date style, then the time style, these being one of the constants
     ...
     *                          for the time and the date) or a
     *                          {@link "http://www.php.net/manual/en/language.types.string.php" string} with the format
     *                          described in
     *                          {@link "http://www.icu-project.org/apiref/icu4c/classSimpleDateFormat.html#details" the ICU documentation}. If <br>NULL</br>, the default style will be used.
     *                          </p>
     * @param  string  $locale  [optional] <p>
     *                          The locale to use, or <b>NULL</b> to use the
     *                          {@link "http://www.php.net/manual/en/intl.configuration.php#ini.intl.default-locale"default one}.</p>
     *
...
class IntlCalendar
{
     ...
     *                       date/time
     *                       {@link http://www.php.net/manual/en/class.intlcalendar.php#intlcalendar.constants field constants}. These are integer values between <em>0</em> and
     *                       <b>IntlCalendar::FIELD_COUNT</b>.
     *                       </p>
     * @param  int  $amount  <p>The signed amount to add to the current field. If the amount is positive, the instant
     *                       will be moved forward; if it is negative, the instant wil be moved into the past. The unit
     *                       is implicit to the field type. For instance, hours for
     ...
     * Also returns <b>FALSE</b> on failure. You can use
     * {@link http://www.php.net/manual/en/intl.configuration.php#ini.intl.use-exceptions exceptions} or
     ...
     * {@link http://www.php.net/manual/en/function.date-default-timezone-set.php date_default_timezone_set()} and as
     * returned by
     * {@link http://www.php.net/manual/en/function.date-default-timezone-get.php date_default_timezone_get()}.
     * </p>
     * </li>
     * <li>
     * <p>
     ...
     * </p>
     * @param  string  $locale    [optional] <p>
     *                            A locale to use or <b>NULL</b> to use
     *                            {@link http://www.php.net/manual/en/intl.configuration.php#ini.intl.default-locale the default locale}.
     *                            </p>
     *
     * @return IntlCalendar
     ...
     * {@link http://www.php.net/manual/en/function.intl-get-error-code.php intl_get_error_code()}.
     * </p>
     */
     ...
     * {@link http://www.php.net/manual/en/class.intlcalendar.php#intlcalendar.constants field constants}. These are
     * integer values between <em>0</em> and
     * <b>IntlCalendar::FIELD_COUNT</b>.
     * </p>
     *
     ...
     *                           A {@link http://www.php.net/manual/en/class.datetime.php DateTime} object or a
     *                           {@link http://www.php.net/manual/en/language.types.string.php string} that can be
     *                           passed to
     ...
     *
     * @param  int  $field  <p>
     *                      One of the {@link www.php.net/manual/en/class.intlcalendar.php IntlCalendar} date/time
     *                      {@link http://www.php.net/manual/en/class.intlcalendar.php#intlcalendar.constants field constants}. These are integer values between <em>0</em> and
     *                      <b>IntlCalendar::FIELD_COUNT</b>.
     *                      </p>
     *
     ...
     * specifying invalid field values on non-lenient mode; use
     * {@link http://www.php.net/manual/en/intl.configuration.php#ini.intl.use-exceptions exceptions} or query
     ...
     * a date out of bounds on non-lenient mode; use
     * {@link http://www.php.net/manual/en/intl.configuration.php#ini.intl.use-exceptions exceptions} or query
 ...
 *                       <b>NULL</b>, in which case the default timezone will be used, as specified in
 *                       the ini setting
 *                       {@link "http://php.net/manual/en/datetime.configuration.php#ini.date.timezone" date.timezone}
 *                       or through the function
 *                       {@link "http://php.net/manual/en/function.date-default-timezone-set.php" date_default_timezone_set()} and as returned by {@link "http://php.net/manual/en/function.date-default-timezone-get.php" date_default_timezone_get()}.
 *                       </p>
 *                       </li>
 *                       <li>
 *                       <p>
 ...
 *                       ICU timezone identifier. See <b>IntlTimeZone::createTimeZoneIDEnumeration()</b>. Raw offsets
 *                       such as <em>"GMT+08:30"</em> are also accepted.
 *                       </p>
 *                       </li>
 *                       </ul>
 *                       </p>
 ...
 * @param  mixed   $format  [optional] <p>
 *                          How to format the date/time. This can either be an
 *                          {http://www.php.net/manual/en/language.types.array.php array}  with two elements (first the
 *                          date style, then the time style, these being one of the constants
 *                          <b>IntlDateFormatter::NONE</b>,
 *                          <b>IntlDateFormatter::SHORT</b>,
 *                          <b>IntlDateFormatter::MEDIUM</b>,
 *                          <b>IntlDateFormatter::LONG</b>,
 ...
 *                          the value of one of these constants (in which case it will be used both
 *                          for the time and the date) or a
 *                          {@link http://www.php.net/manual/en/language.types.string.php} with the format described in
 *                          {@link http://www.icu-project.org/apiref/icu4c/classSimpleDateFormat.html#details the ICU documentation} documentation. If <b>NULL</b>, the default style will be used.
 *                          </p>
 * @param  string  $locale  [optional] <p>
 ...
 *                                  instant will be moved forward; if it is negative, the instant wil be moved into the
 *                                  past. The unit is implicit to the field type. For instance, hours for
 ...
 * through the function
 * {@link http://www.php.net/manual/en/function.date-default-timezone-set.php date_default_timezone_set()} and as
 * returned by  {@link http://www.php.net/manual/en/function.date-default-timezone-get.php
 ...
 *                                  </p>
 *
 * @return bool Returns <b>TRUE</b> on success or <b>FALSE</b> on failure. Failure can only occur is invalid arguments
 *              are provided.
 */
 ...
 *
 * @return int
 * An {@link http://www.php.net/manual/en/language.types.integer.php int} representing the maximum value in the units
 * associated with the given <em>field</em> or <b>FALSE</b> on failure.
 */
 ...
 *                                  One of the {@link http://www.php.net/manual/en/class.intlcalendar.php IntlCalendar}
 *                                  date/time
 *                                  {@link http://www.php.net/manual/en/class.intlcalendar.php#intlcalendar.constants field}. These are integer values between <em>0</em> and
 *                                  <b>IntlCalendar::FIELD_COUNT</b>.
 *                                  </p>
 *
 * @return int
 ...
 *
 * @return bool
 * A {@link http://www.php.net/manual/en/language.types.boolean.php bool} representing whether the calendar is set to
 * lenient mode.
 */
 ...
 * @param  mixed  $dateTime  <p>
 *                           A {@link http://www.php.net/manual/en/class.datetime.php DateTime} object or a
 *                           {@link http://www.php.net/manual/en/language.types.string.php string} that can be passed
 *                           to  {@link http://www.php.net/manual/en/datetime.construct.php DateTime::__construct()}.
 *                           </p>
 *
 * @return IntlCalendar
 * The created {@link http://www.php.net/manual/en/class.intlcalendar.php IntlCalendar} object or <b>NULL</b> in case
 * of
 * failure. If a {@link http://www.php.net/manual/en/language.types.string.php string} is passed, any exception that
 * occurs inside the {@link http://www.php.net/manual/en/class.datetime.php DateTime} constructor is propagated.
 */
 ...
 *                                  </p>
 *
 * @return string The error message associated with last error that occurred in a function call on this object, or a
 *                string indicating the non-existance of an error.
 */
