...
class IntlChar
{
     ...
     *
     * @param  mixed  $codepoint  The integer codepoint value (e.g. 0x2603 for U+2603 SNOWMAN), or the character
     *                            encoded as a UTF-8 string (e.g. "\u{2603}")
     ...
     *
     * @param  string  $codepoint  <p>The integer codepoint value (e.g. <em>0x2603</em> for <em>U+2603 SNOWMAN</em>),
     ...
     * @param  mixed     $limit       One more than the last code point in the enumeration range (the first one after
     *                                the range).
     ...
     *                                <li>integer <em>$nameChoice</em> - The same value as the <b>nameChoice</b>
     *                                parameter below</li>
     ...
     *
     * @param  string  $alias  The property name to be matched. The name is compared using "loose matching" as
     *                         described in PropertyAliases.txt.
     *
     ...
     *                           <p><b>IntlChar::PROPERTY_INVALID_CODE</b> should not be used. Also, if property is out
     *                           of range, FALSE is returned.</p>
     ...
     *                           </p>
     * @param  int  $value       <p>
     *                           Selector for a value for the given property. If out of range, <b>FALSE</b> is
     *                           returned.
     *                           </p>
     *                           <p>
     ...
     *                           </li>
     *                           <li>
     *                           <b>IntlChar::PROPERTY_CANONICAL_COMBINING_CLASS</b> values are not contiguous and
     *                           range from 0..240.
     *                           </li>
     *                           </ul>
     * @param  int  $nameChoice  [optional] <p>
     *                           Selector for which name to get. If out of range, FALSE is returned.
     *                           All values have a long name. Most have a short name, but some do not. Unicode allows
     *                           for additional names; if present these will be returned by adding 1, 2, etc. to
