...
class ffmpeg_movie
{
     ...
     * @param  boolean  $persistent     - Whether to open this media as a persistent resource. See the PHP
     *                                  documentation for more info about persistent resources
     */
     ...
     *
     * @param  int  $framenumber  - Frame from the movie to return. If no framenumber is specified, returns the next
     *                            frame of the movie.
     *
     * @return ffmpeg_frame
     */
...
class ffmpeg_frame
{
     ...
     *                            NOTE: Cropping is always applied to the frame before it is resized. Crop values must
     *                            be even numbers.
     */
...
class ffmpeg_animated_gif
{
     ...
     * @param  int     $loop_count        - Number of times to loop the animation. Put a zero here to loop forever or
     *                                    omit this parameter to disable looping.
     */
